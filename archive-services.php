    ...
    <main role="main" class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="rowFlex mb-20-60">
                ...
                <?php if( have_posts() ){ while( have_posts()  ){  the_post(); if (get_the_ID() != 1099) { ?>
        ...
        <?php
        if (CFS()->get('seo3_text_title_' . LOCALE, 786) != "" && CFS()->get('seo3_text_' . LOCALE, 786) != "") {
            ?>
            <div class="bg-gray">
                <div class="container-fluid all-text">
                    <h4><?php echo CFS()->get('seo3_text_title_' . LOCALE, 786); ?></h4>

                        <div class="all-text-column">
                            <?php echo apply_filters('the_content', CFS()->get('seo3_text_' . LOCALE, 786)); ?>
                        </div>

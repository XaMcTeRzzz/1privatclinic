    ...
    function get($id, $group = 'default', $doNotTestCacheValidity = false)
    {
        ...
        if ($this->_caching) {
            ...
            if ($this->_memoryCaching) {
                if (isset($this->_memoryCachingArray[$this->_file])) {
                    if ($this->_automaticSerialization) {
                        return unserialize($this->_memoryCachingArray[$this->_file], ['allowed_classes' => WP_Error::class]);
                    }
            ...
            if (($this->_automaticSerialization) and (is_string($data))) {
                $data = unserialize($data, ['allowed_classes' => WP_Error::class]);
            }
            return $data;
        }
        return false;
    ...
    function getMemoryCachingState($id, $group = 'default', $doNotTestCacheValidity = false)
    {
        if ($this->_caching) {
            if ($data = $this->get($id, $group, $doNotTestCacheValidity)) {
                $array = unserialize($data, ['allowed_classes' => WP_Error::class]);
...
//	    print_r([$msg, $code, $this->_pearErrorMode]);

<div class="c-modal" id="js-cabinet-login-modal">
	<div class="c-modal__wrap">

		<div class="c-modal__header">
			<div class="c-modal__header-title"
			     style="margin-bottom: 0;"><?php _e("Вхід до особистого кабінету", 'mz') ?></div>
			<?php if (1 > 2): ?>
				<div class="c-modal__header-subtitle">
					<span><?php _e("Немає особистого кабінету?", 'mz') ?></span>
					<a href="javascript:;"
					   id="js-open-cabinet-registration-modal"><?php _e("зареєструватися", 'mz') ?>
					</a>
				</div>
			<?php endif; ?>
		</div>
		<div class="c-modal__body-subtitle c-m-ltr-20-50">
			<span><?php _e("Доступ до особистого кабінету надається пацієнтам, 
				які зареєстровані в базі даних ТОВ \"МЕДІСТАР-А\".
				Якщо бажаєте здійснити запис на прийом без реєстрації перейдіть за ", 'mz') ?><a
					href="<?php echo get_home_url(null, '/vse-vrachi/'); ?>"><?php
					_e("посиланням", 'mz') ?></a></span>
		</div>
		<div class="c-modal__body">
			...
			<form id="js-cabinet-login-form" class="form-default">
				...
				<div class="c-modal__body-agreements">
					<label>
						<input name="agreement1"
						       type="checkbox"
						       id="agreement1"
						       required=""/><?php _e("Я даю згоду на обробку даних та приймаю ", 'mz') ?>
						<a href="<?php echo get_home_url(null, '/dogovir-na-obrobku-personalnih-danih/'); ?>"
						   target="_blank"><?php _e("договір про обробку персональних даних", 'mz') ?></a>
					</label>
					<label>
						<input name="agreement2"
						       type="checkbox"
						       id="agreement2"
						       required=""/><?php _e("Я приймаю ", 'mz') ?>
						<a href="<?php echo get_home_url(null, '/dogovor-oferty/'); ?>"
						   target="_blank"><?php _e("публічний договір про надання медичних послуг", 'mz') ?></a>
					</label>
				</div>
				...
				<div class="c-modal__body-buttons">
					...
					<button class="btn"
					        id="js-cabinet-login-button"><?php _e("увійти", 'mz') ?></button>
				</div>
			</form>
		</div>

<div class="modal-with-footer" id="check_up_modal">
    <div class="modal modal-xl" >
        <div class="modal__title"><?php _e("Запись на чекап",'mz') ?></div>
        <form class="form-default js__form_check_up" method="post">
            ...
            <label class="input-form"><?php _e('Желаемая дата записи','mz')?>*
                <input type="date"
                       name="date"
            ...
            <div class="text-center">
                <button type="submit" class="btn w-100"><?php _e('записаться','mz')?></button>
            </div>
        </form>
    </div>
